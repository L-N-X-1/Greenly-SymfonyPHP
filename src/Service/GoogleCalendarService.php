...
class GoogleCalendarService
{
    ...
    public function __construct(string $credentialsPath, string $calendarId, string $clientId, string $clientSecret)
    {
    ...
    private function initClient(): void
    {
        ...
        // Set client ID and secret from constructor parameters
